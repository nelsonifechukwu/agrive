...
global $where_clause;
			...
			$records = "SELECT * FROM `farm_conditions` ". $where_clause . " ORDER BY `id` DESC";
			...
			if($get_records){
				...
				<p> <?php echo $param['temperature']; ?> </p>
				<p> <?php echo $param['humidity']; ?> </p>
				<p> <?php echo $param['light_intensity']; ?> </p>
				<p> <?php echo $param['soil_moisture']; ?> </p>
				<p> <?php echo $param['pressure']; ?> </p>
